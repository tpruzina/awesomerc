...
globalkeys = awful.util.table.join(globalkeys,
    ...
    awful.key({ }, "XF86MonBrightnessDown", function () awful.util.spawn(brightness_cmd .. " -dec 10") end),
    awful.key({ }, "XF86MonBrightnessUp", function () awful.util.spawn(brightness_cmd .. " -inc 10") end),
