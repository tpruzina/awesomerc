...
run_once("firefox","/usr/local/bin/setscreen")
run_once("firefox","firefox-bin")
...
--run_once("xrandr --output HDMI1 --auto")
...
if screen.count() == 1 then
    tags1_1 = {
              ...
              layout = { layouts[1], layouts[1], layouts[1], layouts[4], layouts[1], layouts[1], layouts[3] }
              }
...
kbdcfg.current = 1
    ...
    kbdcfg.switch = function ()
        ...
        awful.util.spawn("sh /home/tomas/bin/annoucekb")
end
...
-- makes use of key just above WINKEY -- easy acces to kill() and run()
awful.util.spawn("xmodmap -e 'keysym Multi_key = Super_R'")
